...
class TestAPI(unittest.TestCase):
    ...
    @unittest.skip("Requires FastAPI lifespan fixture - complex async mocking")
    @patch.object(load_model, "fetch_model_with_retry", new_callable=AsyncMock)
    @patch("services.inference_service.app._run_prediction", return_value=(1, 0.95))
